...
Project-specific rules that extend or override the Google-style corpora (`01_language_rules.md`, `02_style_rules.md`). Review-focused rules live verbatim in the always-loaded `existence-bible` skill and win on conflict; this file accumulates personal typing and language practice. On conflict with the Google corpora, this file wins.

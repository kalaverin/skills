---
source_hash: ab7be8ff876f91af
source_path: lib/std/appdirs.nim
---
...
**Output:** `Path`
**Pragmas:** `inline`, `raises: []`, `tags: [ReadEnvEffect]`, `forbids: []`
...
**Note:**
This proc does not check whether the returned path exists.

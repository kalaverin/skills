---
source_hash: 8680b02c134d3b59
source_path: lib/pure/strscans.nim
---
...
| $w | Matches an ASCII identifier: [A-Za-z\_][A-Za-z\_0-9]\*. |
...
# [Startswith vs full match](#startswith-vs-full-match)
...
# [User definable matchers](#user-definable-matchers)
...
# [The scanp macro](#the-scanp-macro)
...
[ref: #symbol-scantuple]

**Input:**
- `input: untyped`
- `pattern: static[string]`
- `matcherTypes: varargs[untyped]`
